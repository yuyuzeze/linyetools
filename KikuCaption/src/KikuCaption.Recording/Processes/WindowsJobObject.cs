...
/// <summary>
/// Kill-on-close Job Object: assigning the FFmpeg process guarantees it is terminated when
/// KikuCaption exits (even on a crash), so no orphan FFmpeg process is left behind.
/// </summary>
...
internal sealed class WindowsJobObject : IDisposable
{
    ...
    private static extern bool SetInformationJobObject(SafeFileHandle hJob, int infoClass, IntPtr info, uint length);
